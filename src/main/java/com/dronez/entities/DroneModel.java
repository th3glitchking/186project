...
public class DroneModel<T extends Drone> extends EntityModel<T> {
	...
	public DroneModel() {
		...
		RendererModel holdy_bits = new RendererModel(this);
		holdy_bits.setRotationPoint(0.0F, 0.0F, 0.0F);
		flying_1.addChild(holdy_bits);
		holdy_bits.cubeList.add(new ModelBox(holdy_bits, 25, 10, -8.0F, -4.0F, 4.0F, 1, 1, 1, 0.0F, false));
		holdy_bits.cubeList.add(new ModelBox(holdy_bits, 25, 10, -7.0F, -3.0F, 3.0F, 2, 1, 1, 0.0F, false));

		RendererModel blades = new RendererModel(this);
		...
		RendererModel holdy_bits2 = new RendererModel(this);
		holdy_bits2.setRotationPoint(0.0F, 0.0F, 0.0F);
		flying_2.addChild(holdy_bits2);
		holdy_bits2.cubeList.add(new ModelBox(holdy_bits2, 25, 10, -8.0F, -4.0F, 4.0F, 1, 1, 1, 0.0F, false));
		holdy_bits2.cubeList.add(new ModelBox(holdy_bits2, 25, 10, -7.0F, -3.0F, 3.0F, 2, 1, 1, 0.0F, false));

		RendererModel blades2 = new RendererModel(this);
		...
		RendererModel holdy_bits3 = new RendererModel(this);
		holdy_bits3.setRotationPoint(0.0F, 0.0F, 0.0F);
		flying_3.addChild(holdy_bits3);
		holdy_bits3.cubeList.add(new ModelBox(holdy_bits3, 25, 10, -5.0F, -4.0F, 7.0F, 1, 1, 1, 0.0F, false));
		holdy_bits3.cubeList.add(new ModelBox(holdy_bits3, 25, 10, -4.0F, -3.0F, 5.0F, 1, 1, 2, 0.0F, false));

		RendererModel blades3 = new RendererModel(this);
		...
		RendererModel holdy_bits4 = new RendererModel(this);
		holdy_bits4.setRotationPoint(0.0F, 0.0F, 0.0F);
		flying_4.addChild(holdy_bits4);
		holdy_bits4.cubeList.add(new ModelBox(holdy_bits4, 25, 10, -5.0F, -4.0F, 7.0F, 1, 1, 1, 0.0F, false));
		holdy_bits4.cubeList.add(new ModelBox(holdy_bits4, 25, 10, -4.0F, -3.0F, 5.0F, 1, 1, 2, 0.0F, false));

		RendererModel blades4 = new RendererModel(this);
